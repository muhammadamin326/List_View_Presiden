...
import com.example.Listv_presiden.Model
import com.example.listv_presiden.R
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.add(Model("Ir soekarno", "Presiden ke-1 Indonesia.", R.drawable.p1))
        list.add(Model("Soeharto", "Presiden ke-2 Indonesia.", R.drawable.p2))
        list.add(Model("BJ Habibie", "Presiden ke-3 Indonesia.", R.drawable.p3))
        list.add(Model("Abdurrahman Wahid", "Presiden ke-4 Indonesia.", R.drawable.p4))
        list.add(Model("megawati", "Presiden ke-5 Indonesia", R.drawable.p5))
        list.add(Model("Susilo Bambang Yudhoyono", "Presiden ke-6 Indonesia", R.drawable.p6))
        list.add(Model("Joko Widodo", "Presiden ke-7 Indonesia", R.drawable.p7))
